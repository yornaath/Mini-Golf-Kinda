...
export function wasm_bindgen__convert__closures__invoke1_mut__h2605b4fc55aee9b0(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h43f4382b3872ab64(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbc7ccddeee6154bc(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h319c930014b0dcec(a: number, b: number, c: number): void;
